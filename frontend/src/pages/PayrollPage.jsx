  ...
  return (
    <div className="rounded-lg border border-slate-200 bg-white p-4 shadow-sm">
      <div className="flex items-start justify-between gap-3">
        ...
        <div
          className={`flex h-11 w-11 shrink-0 items-center justify-center rounded-lg ${tones[tone]} text-white`}
        >
  ...
  return (
    ...
    >
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-2xl text-sm font-medium text-slate-500">
              Theo dõi lương tạm tính, xử lý ca thiếu chấm công hoặc đi trễ, và
              cộng thưởng/phạt theo từng ngày làm việc.
            </p>
          </div>
        ...
        >
          ...
          <label className="text-sm font-bold text-slate-700">
            ...
            <input
              ...
              className="mt-1 h-12 w-full rounded-lg border border-slate-200 px-3 outline-none focus:border-cyan-500"
            />
          </label>
          <label className="text-sm font-bold text-slate-700">
            Đến ngày
      ...
      <section className="overflow-hidden rounded-lg border border-slate-200 bg-white shadow-sm">
        {loading ? (
          <div className="flex h-56 items-center justify-center text-sm font-bold text-slate-500">
            Đang tải dữ liệu...
          </div>
          ...
          <div className="p-4">
            ...
            <div className="mt-4 grid gap-3 md:grid-cols-3">
              ...
              <StatCard
                ...
                label="Tổng thưởng"
                value={money(totals.bonus_salary)}
                sub={`Tổng phạt ${money(totals.penalty_salary)}`}
                tone="amber"
              />
            </div>
          </div>
